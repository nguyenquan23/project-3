...
<section class="get-in-touch">
   ...
   <form class="contact-form row"  action="<c:url value='/admin-update?action=update'/>"  method="get">
      ...
      <label >Địa chỉ</label>
         ...
         <input id="company" class="input-text js-input" type="hidden" required name="inspectId" value="<%=inspect.getId() %>">
         <input id="company" class="input-text js-input" type="hidden" required name="action" value="update">
