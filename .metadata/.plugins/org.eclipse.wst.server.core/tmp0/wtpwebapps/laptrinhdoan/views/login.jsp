...
<link href="<c:url value='/template/login/bootstrap/css/style.css' />"
			...
			<div class="row">
				<div class="col-sm-6 text-black">
					...
					<div class="px-5 ms-xl-4">
						...
						<div class="alert alert-${alert}" id="myElem">${message}</div>
					...
					<div
						...
						<form style="width: 23rem;"
							action="<c:url value='/checklogin'/>" method="post">
